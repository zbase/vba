...
if __name__ == '__main__':
    ...
    vbs_manager = vbsManager.VBSManager(vbs_host, vbs_port, as_mgr)
    migration_mgr = migrationManager.MigrationManager(vbs_manager)
    mb_mgr = mbManager.MembaseManager(vbs_manager)
